...
the paths ghw cares about. The snapshot concept was introduced [to make ghw easier to test](https://github.com/imhinotori/ghw/issues/66).
...
expect, we recommend to check also the [project issues](https://github.com/imhinotori/ghw/issues) and the `git` history to have the full picture.
...
because both pseudo filesystems make use of symlinks, and [docker doesn't really play nice with symlinks](https://github.com/imhinotori/ghw/commit/f8ffd4d24e62eb9017511f072ccf51f13d4a3399).
